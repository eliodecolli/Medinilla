...
public class OcppMessageTokenizerJsonShould
{
    public const string RawMessage =
        "[2, \"123-abc-456-def\", \"BootNotification\", {\"reason\": \"PowerUp\",\"chargingStation\": {\"model\": \"Test Model\", \"vendor\": \"Test Vendor\"}}]";
    ...
    {
        var tokenizer = new OcppMessageTokenizerJson();
    ...
    public void PanicWhenInvalidMessage()
    {
        ...
        // idk what the fuck is going on here so let's just catch em all
        Assert.ThrowsAny<Exception>(() => tokenizer.Tokenize(RawMessageInvalid));
    }
}
